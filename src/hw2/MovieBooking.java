...
public class MovieBooking extends JFrame 
    ...
    { 
        ...
        evening.setFont(new Font("Arial", Font.PLAIN, 15)); 
        evening.setSelected(true); 
        evening.setSize(75, 20); 
        evening.setLocation(200, 200); 
        c.add(evening); 
  
        night = new JRadioButton("Night"); 
        night.setFont(new Font("Arial", Font.PLAIN, 15)); 
        night.setSelected(false); 
        night.setSize(80, 20); 
        night.setLocation(275, 200); 
        c.add(night); 
        ...
        dob = new JLabel("Date of Booking"); 
